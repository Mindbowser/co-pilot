---
title: Epico Pilot 使用 Llama 3.1
description: Epico Pilot 如何使用 Llama 3.1
keywords: [llama, meta, togetherai, novita, ollama, replicate]
---

Epico Pilot 让使用最新的开元模型编码变得简单，包括整个 Llama 3.1 家族模型。

如果你还没有安装 Epico Pilot ，你可以安装 [VS Code 在这里](https://marketplace.visualstudio.com/items?itemName=Epico Pilot.continue) 或者 [JetBrains 在这里](https://plugins.jetbrains.com/plugin/22707-continue) 。对于更通用的定制 Epico Pilot 的信息，查看 [我们的定制文档](../overview.md) 。
