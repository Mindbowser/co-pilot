...
In Epico Pilot, rerankers are designated using the `rerank` role and used by [@Codebase](../deep-dives/codebase.mdx) in order to select the most relevant code snippets after vector search.
...
<Tabs groupId="hub-config-example">
  ...
  [Voyage Rerank 2 Block](https://hub.epico-pilot.dev/voyageai/rerank-2)
  </TabItem>
...
<Tabs groupId="config-example">
  ...
  {/* <TabItem value="hub" label="Hub">
  [Cohere Reranker English v3](https://hub.epico-pilot.dev/)
  </TabItem> */}
  <TabItem value="yaml" label="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs groupId="config-example">
  {/* HUB_TODO block doesn't exist */}
  {/* <TabItem value="hub" label="Hub">
  [GPT-4o LLM Reranker Block](https://hub.epico-pilot.dev/)
  </TabItem> */}
  <TabItem value="yaml" label="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs groupId="config-example">
  {/* HUB_TODO */}
  {/* <TabItem value="hub" label="Hub">
  [HuggingFace TEI Reranker block](https://hub.epico-pilot.dev/)
  </TabItem> */}
    <TabItem value="yaml" label="YAML">
    ```yaml title="config.yaml"
    models:
