...
In Epico Pilot, these models are used for [Chat](../../chat/how-to-use-it.md) and [Actions](../../actions/how-to-use-it.md). The selected chat model will also be used for [Edit](../../edit/how-to-use-it.md) and [Apply](./apply.mdx) if no `edit` or `apply` models are specified, respectively.
...
<Tabs groupId="hub-config-example">
  ...
  View the [Claude 3.7 Sonnet model block](https://hub.epico-pilot.dev/anthropic/claude-3-7-sonnet) on the hub.
  </TabItem>
...
<Tabs groupId="config-example">
  ...
  {/* <TabItem value="hub" label="Hub">
    <Tabs groupId="providers">
        ...
        Add the [Together Llama 3.1 405b block](https://hub.epico-pilot.dev/explore/assistants) from the hub
        </TabItem>
         <TabItem value="Groq">
        Add the [Groq Llama 3.1 405b block](https://hub.epico-pilot.dev/explore/assistants) from the hub
        </TabItem>
        <TabItem value="vLLM">
        Add the [vLLM Llama 3.1 405b block](https://hub.epico-pilot.dev/explore/assistants) from the hub
        </TabItem>
        <TabItem value="Ollama">
        Add the [Ollama Llama 3.1 405b block](https://hub.epico-pilot.dev/explore/assistants) from the hub
        </TabItem>
    </Tabs>
  </TabItem> */}
  <TabItem value="yaml" label="YAML">
...
<Tabs groupId="hub-config-example">
    <TabItem value="hub" label="Hub">
    Add the [OpenAI GPT-4o block](https://hub.epico-pilot.dev/openai/gpt-4o) from the hub
    </TabItem>
  <TabItem value="yaml" label="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs groupId="hub-config-example">
    <TabItem value="hub" label="Hub">
    Add the [xAI Grok-2 block](https://hub.epico-pilot.dev/xai/grok-2) from the hub
    </TabItem>
  <TabItem value="yaml" label="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs groupId="hub-config-example">
    <TabItem value="hub" label="Hub">
    Add the [Gemini 2.0 Flash block](https://hub.epico-pilot.dev/google/gemini-2.0-flash) from the hub
    </TabItem>
  <TabItem value="yaml" label="YAML">
  ```yaml title="config.yaml"
  models:
...
<Tabs groupId="hub-config-example">
  <TabItem value="hub" label="Hub">
    ...
    Add the [Ollama Llama 3.1 8b block](https://hub.epico-pilot.dev/ollama/llama3.1-8b) from the hub
    </TabItem>
    {/* HUB_TODO nonexistent block */}
    {/* <TabItem value="lmstudio" label="LM Studio">
    Add the [LM Studio Llama 3.1 8b block](https://hub.epico-pilot.dev/explore/models) from the hub
    </TabItem> */}
    </Tabs>
  </TabItem>
  <TabItem value="yaml" label="YAML">
...
<Tabs groupId="config-example">
  ...
  {/* <TabItem value="hub" label="Hub">
    <Tabs groupId="providers">
    <TabItem value="ollama" label="Ollama">
    Add the [Ollama Deepseek Coder 2 16B block](https://hub.epico-pilot.dev/explore/models) from the hub
    </TabItem>
    <TabItem value="lmstudio" label="LM Studio">
    Add the [LM Studio Deepseek Coder 2 16B block](https://hub.epico-pilot.dev/explore/models) from the hub
    </TabItem>
    </Tabs>
  </TabItem> */}
  <TabItem value="yaml" label="YAML">
