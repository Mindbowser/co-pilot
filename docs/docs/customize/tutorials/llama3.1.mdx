---
title: Using Llama 3.1 with Epico Pilot
description: How to use Llama 3.1 with Epico Pilot
...
Epico Pilot makes it easy to code with the latest open-source models, including the entire Llama 3.1 family of models. Llama 3.2 models are also supported but not recommended for chat, because they are specifically designed to be small or multi-modal.

If you haven't already installed Epico Pilot, you can do that [here for VS Code](https://marketplace.visualstudio.com/items?itemName=Epico Pilot.epico-pilot) or [here for JetBrains](https://plugins.jetbrains.com/plugin/22707-epico-pilot). For more general information on customizing Epico Pilot, read [our customization docs](../overview.md).
...
3. Change your Epico Pilot config file like this:
...
2. Update your Epico Pilot config file like this:
...
3. Update your Epico Pilot config file like this:
...
2. Change your Epico Pilot config file like this:
...
2. Create and copy the API key for use in Epico Pilot.
3. Update your Epico Pilot config file:
