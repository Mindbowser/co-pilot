...
If you haven't already installed Epico Pilot, you can do that [here for VS Code](https://marketplace.visualstudio.com/items?itemName=Mindbowser.epico-pilot) or [here for JetBrains](https://plugins.jetbrains.com/plugin/22707-epico-pilot). For more general information on customizing Epico Pilot, read [our customization docs](../overview.md).
