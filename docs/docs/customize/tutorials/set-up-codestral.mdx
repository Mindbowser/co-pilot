...
![mistral x epico-pilot](../../../static/img/mistral-x-epico-pilot.png)

**Here is a step-by-step guide on how to set up Codestral with Epico Pilot using the Mistral AI API:**

1. Install the Epico Pilot VS Code or JetBrains extension following the instructions [here](../../getting-started/install.md)

2. Click on the gear icon in the bottom right corner of the Epico Pilot window to open `~/.epico-pilot/config.json` (MacOS) / `%userprofile%\.epico-pilot\config.json` (Windows)
