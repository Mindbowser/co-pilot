...
Cloudflare Workers AI can be used for both chat and tab autocompletion in Epico Pilot. Here is an example of Cloudflare Workers AI configuration:
...
[View the source](https://github.com/Mindbowser/co-pilot/blob/main/core/llm/llms/Cloudflare.ts)
