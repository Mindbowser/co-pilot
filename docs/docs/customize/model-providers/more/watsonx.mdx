...
To authenticate to watsonx.ai SaaS with Epico Pilot, you will need to create a project and [set up an API key](https://www.ibm.com/docs/en/mas-cd/continuous-delivery?topic=cli-creating-your-cloud-api-key). Then, in epico-pilot:
...
To authenticate to your watsonx.ai Software instance with Epico Pilot, you can use either `username/password` or `ZenApiKey` method:
