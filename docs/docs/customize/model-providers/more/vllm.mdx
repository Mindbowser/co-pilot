...
The epico-pilot implementation uses [OpenAI](../top-level/openai.mdx) under the hood. [View the source](https://github.com/Mindbowser/co-pilot/blob/main/core/llm/llms/Vllm.ts)
