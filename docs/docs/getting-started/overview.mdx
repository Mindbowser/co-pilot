---
title: Overview
description: Getting started with Epico Pilot
...
To quickly understand what you can do with Epico Pilot, check out each tab below.
...
<Tabs>
  ...
  <TabItem value="s" label="Actions">
    ...
    [Actions](../actions/how-to-use-it.md#how-to-use-it) are shortcuts for common use cases

    ![actions](/img/actions.gif)

    <Admonition type="info" title="Learn more" icon="📚">
        Learn more about how to use [Actions](../actions/how-to-use-it.md#how-to-use-it)
    </Admonition>
