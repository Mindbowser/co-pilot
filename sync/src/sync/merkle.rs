...
mod tests {
    ...
    fn test_compute_tree_for_temp_dir() {
        let temp_dir = TempDirBuilder::new()
            ...
            .add("dir2/subdir/epico-pilot.py", "[epico-pilot for i in range(10)]")
            .add("__init__.py", "a = 5")
            .create();
        ...
        let temp_dir2 = TempDirBuilder::new()
            ...
            .add("dir1/file2.txt", "Hello, world!")
            .add("dir2/file3.txt", "Hello, world!")
            .add("dir2/subdir/epico-pilot.py", "[epico-pilot for i in range(11)]") // Difference here
            .add("__init__.py", "a = 5")
            .create();
        ...
        let path = temp_dir.path().join("dir2/subdir/epico-pilot.py");
        fs::write(path, "[epico-pilot for i in range(11)]").expect("Failed to write to file");
        let tree_prime =
            compute_tree_for_dir(temp_dir.path(), None).expect("Failed to compute tree");

        // All nodes up the tree from dir2/subdir/epico-pilot.py should be marked as changed
